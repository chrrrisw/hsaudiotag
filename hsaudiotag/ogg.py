...
class VorbisComment:
    def __init__(self, data):
        ...
        part_str = get_field(b'DISCNUMBER')
        m = RE_STARTS_WITH_DIGIT.match(part_str)
        self.part_of_set = int(m.group(0)) if m else 0
...
class Vorbis:
    ...
    def _read(self, fp):
        ...
        (file_id, version, channel_mode, sample_rate,
            bitrate_max, bitrate_nominal, bitrate_max,
        ...
        self.part_of_set = comment.part_of_set
        ...
        # Seek last page to get sample count. It's impossible to not have
        # at least one page in the last 64kb.
